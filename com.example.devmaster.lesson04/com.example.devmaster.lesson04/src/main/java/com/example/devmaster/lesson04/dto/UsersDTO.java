package com.example.devmaster.lesson04.dto;
...
public class UsersDTO {
    ...
    @Size(min=3, max=20, message = "Usernam must be between 3 and 20 characters")
    @Column(unique=true)
    String username;

    @NotBlank(message ="Password cannot the blank" )
